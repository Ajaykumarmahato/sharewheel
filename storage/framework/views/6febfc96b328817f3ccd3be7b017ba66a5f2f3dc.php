            ...
            <div class="row card pb-5">
                <div class="col-lg-12">
                    <div class="row card-header">
                        <span class="feedback-header-text"><?php echo e($vehicle->vehicle_title); ?></span>
                    ...
                    <div class="row mb-4 mt-4 card-body card-block">
                        ...
                        <div class="col-lg-5 pl-4">
                            ...
                            <p><strong>Brand:</strong> <?php echo e($vehicle->vehicle_brand); ?> <br>
                            ...
                            <p><strong>Cattegory:</strong> <?php echo e($vehicle->vehicle_category); ?><br>
...
<?php echo $__env->make('admin/adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/admin/admin-product-detail.blade.php ENDPATH**/ ?>