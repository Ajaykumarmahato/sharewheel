...
<div class="container mt-5 mb-5">
      ...
      <div class="row">
        ...
        <div class="col-4 my-bg mt-4 pt-3">
          ...
          <form method="POST" action="<?php echo e(route('login')); ?>" class="mt-4 mb-4">
          <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="float-left mt-2 mb-5">
              <button type="submit" class="btn btn my-button text-light">Login</button>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-09-06-10_30pm\ShareWheel\resources\views/auth/login.blade.php ENDPATH**/ ?>