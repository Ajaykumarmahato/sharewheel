                    ...
                    <div class="col-lg-6">
                        <div class="input-group mb-4">
                            <input name="contact_name" 
                                value="<?php echo e(Auth::user() ? auth()->user()->first_name : ''); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-lg-6">
                        <div class=" input-group mb-4">
                            <input name="contact_email" value="<?php echo e(Auth::user() ? auth()->user()->email : ''); ?>"
                                type="text" class="my-input form-control <?php $__errorArgs = ['contact_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/contact.blade.php ENDPATH**/ ?>