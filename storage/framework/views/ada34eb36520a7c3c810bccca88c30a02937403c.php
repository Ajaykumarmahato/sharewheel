    ...
    <div class="row mb-5">
        ...
        <div class="col-4">
            <a class="my-link my-logo-fade" href="<?php echo e(asset('/')); ?>"><img class="my-login-logo"
                    src="<?php echo e(asset('/images/logo/logo.png')); ?>" alt="logo" /></a>
        </div>
        <div class="col-4"></div>
    </div>
    <div class="row">
...
unset($__errorArgs, $__bag); ?>"
                        id="first_name" placeholder="First Name" name="first_name" value="<?php echo e(old('first_name')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        id="last_name" placeholder="Last Name" name="last_name" value="<?php echo e(old('last_name')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        id="country_name" placeholder="Country Name" name="country_name"
                        value="<?php echo e(old('country_name')); ?>" autocomplete="country_name" />
...
unset($__errorArgs, $__bag); ?>" id="address"
                        placeholder="Address" name="address" value="<?php echo e(old('address')); ?>" autocomplete="address" />
...
unset($__errorArgs, $__bag); ?>" id="email"
                        placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="email" />
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('contact_number')); ?>" autocomplete="contact_number" />
...
unset($__errorArgs, $__bag); ?>"
                        id="liscence_number" placeholder="Liscence Number" name="liscence_number"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        <button type="submit" name="submit"
                            class="myRegisterButton btn btn-block my-button text-light"></i><i class="fa fa-sign-in"
                                style="color:white;" aria-hidden="true">&nbsp;SignUp</i>
                        </button>
                        <button type="submit" name="submit"
                ...
                <div class="row mt-2">
                    <div class="col-12 pb-4">
                        <p class="my-text">Already Have an Account?<a class="my-link" href="/login">&nbsp;Login
                                Here!</a></p>
                    </div>
                </div>
                <hr>
...
<?php echo $__env->make('auth/auth-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/auth/register.blade.php ENDPATH**/ ?>