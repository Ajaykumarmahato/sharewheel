    ...
    <div class="container">
        <div class="row mt-5 mb-5"></div>
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-4">
                    <a name="leave_message"> <h2 class="my-text text-center"><b>Leave Message</b></h2></a>
                </div>
                <div class="col-lg-4"></div>
            </div>
            ...
            <div class="col-12">
                <a name="address"><h3 class="my-text pt-5 ml-5">Location on Map</h3></a>
            </div>
        </div>
        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-11-06-10_20pm\ShareWheel\resources\views/contact.blade.php ENDPATH**/ ?>