            ...
            <div class="row card">
                <div class="col-lg-12 my-wraper-feedback">
                    <div class="row card-header">
                        ...
                        <a href="/manager-brands/create-brand" class="create-button"><button class="btn my-button">+ Add
                                New Brand</button></a>
                    </div>
...
<?php echo $__env->make('manager/managerLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/manager/manager-brands.blade.php ENDPATH**/ ?>