  ...
  <div class="row mb-5">
    <div class="col my-bg text-center mt-5">
      <h5 class="mt-3 mb-3" style="color: #01a99d;">
        ...
        Any Questions? <a href="<?php echo e(asset('/contact-us')); ?>/#leave_message" class="my-link">Ask here!</a>
      </h5>
    </div>
  </div>
  <div class="row mt-5">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/faq.blade.php ENDPATH**/ ?>