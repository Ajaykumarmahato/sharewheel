                                        ...
                                        <div class="my-radio-button form-check-inline form-check">
                                            ...
                                            <label for="inline-radio3" class="form-check-label pl-3">
                                                <input type="radio" id="inline-radio3" name="vehicle_fuel_type"
                                                    ...
                                                    <?php echo e(($vehicle->vehicle_fuel_type=='Electric')? 'checked' : ''); ?>>Electric
                                            </label>
...
<?php echo $__env->make('manager/managerLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/manager/edit-product.blade.php ENDPATH**/ ?>