                            ...
                            <div class="header-button">
                                ...
                                <div class="noti-wrap">
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <span
                                            class="<?php echo e((request()->is('admin-users')) ? 'd-none' : 'd-block quantity'); ?>"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                                        <?php endif; ?>
                                        <div class="notifi-dropdown js-dropdown">
                                            ...
                                            <div class="notification-scrollble">
                                                ...
                                                <a href="/admin-users/user/user-details-noti/<?php echo e($notification->id); ?>"
                                                    ...
                                                    <div class="notifi__item" style="background-color:#d1fff0">
                                                        ...
                                                        <div class="content">
                                                            <p><?php echo e($notification->data['data']); ?>! <br><br>
                                                                <b><?php echo e($notification->data['user_info']['first_name']); ?>

                                                                    <?php echo e($notification->data['user_info']['last_name']); ?></b>
                                                            </p>
                                                            <span
                                                                class="date"><?php echo e(\Carbon\Carbon::parse($notification->data['user_info']['created_at'])->format('M-d-Y')); ?></span>
                                                        </div>
                                                    </div>
                                                </a>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="/admin-account/<?php echo e(Auth::user()->username); ?>"
...
</html><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/admin/adminLayout.blade.php ENDPATH**/ ?>