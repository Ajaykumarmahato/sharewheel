      ...
      <i class="fa fa-arrow-down text-light pt-2"></i>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
            <input
            class="form-control my-input mr-sm-2"
            type="search"
            placeholder="Search"
            aria-label="Search"
            />
          ...
          <span class="form-inline my-2 my-lg-0">
            ...
            <?php if(auth()->guard()->guest()): ?>
              ...
              <?php else: ?>
                ...
                <a id="navbarDropdown" class="my-link dropdown-toggle mr-5" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                   <img class="my-profile-image" src="/storage/user_profile_images/<?php echo e(Auth::user()->profile_image); ?>" alt=""> <?php echo e(Auth::user()->first_name); ?> <span class="caret"></span>
                </a>

                <div class="dropdown-menu dropdown-menu-right my-dropdown" aria-labelledby="navbarDropdown" style="width:200px">
                    <a class="my-text dropdown-item" href="<?php echo e(route('logout')); ?>"
...
<!-- Header Section End -->
   ...
   <footer class="page-footer font-small my-dropdown pt-4">
      ...
      <div class="container text-center text-md-left">
        ...
        <div class="row pb-4">
          <!-- Grid column -->
          <div class="col-md-2 mx-auto mr-5">
            <!-- Logo-->
          ...
          <div class="col-md-3 mx-auto">
            ...
            <ul class="list-unstyled my-text">
              <li>
              Phone Number: +977 9845867602,5150094
              </li>
              <li>
              <a class="my-link text-decoration-none" href="#"> sharewheel2020@gmail.com</a>
              </li>
              <li>
                <a class="my-pills-text text-decoration-none" href="<?php echo e(asset('/contact')); ?>/#leave_message">Leave a Message! <i class="fa fa-paper-plane"></i> </a>
              </li>
            </ul>
          </div>
          <!-- Grid column -->
...
<hr />
      ...
      <ul class="list-unstyled list-inline text-center py-2">
        ...
        <li class="list-inline-item">
          <a href="<?php echo e(asset('/register')); ?>" class="btn my-button">Sign up!</a>
        </li>
      </ul>
      <!-- Call to action -->
      <hr />
...
</html><?php /**PATH C:\Users\priansu\Desktop\MajorProject-11-06-10_20pm\ShareWheel\resources\views/layout.blade.php ENDPATH**/ ?>