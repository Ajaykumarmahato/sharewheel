...
<html lang="en">
  ...
  <body onload="myPreloader()">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light ml-2 mini-navbar">
      <a href="mailto:sharewheel2020@gmail.com" class="top-item my-text"><i class="fa fa-envelope ml-5">
          sharewheel2020@gmail.com</i></a>
      <span class="ml-3 my-text"> Free oil for the ride!</span>
      <div class="icons ml-auto">
        <a class="my-link" href="#"><i title="Facebook" class="fa fa-facebook ml-5 mr-3"></i></a>
        <a class="my-link" href="#"><i title="Twitter" class="fa fa-twitter mr-3"></i></a>
        <a class="my-link" href="#"><i title="Instagram" class="fa fa-instagram mr-3"></i></a>
        <a class="my-link" href="#"><i title="Youtube" class="fa fa-youtube mr-5"></i></a>
    ...
    <nav class="navbar main-navbar-bg navbar-expand-lg sticky-top">
      <a class="navbar-brand" href="<?php echo e(asset('/')); ?>">
        <img class="my-header-logo" src="<?php echo e(asset('/images/logo/logo.png')); ?>" />
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="<?php echo e((request()->is('contact')) ? 'my-active-link' : 'nav-item'); ?> ">
            <a class="nav-link my-link" href="<?php echo e(asset('/contact')); ?>">Contact Us</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link my-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
            ...
            <div class="dropdown-menu my-brands-dropdown scrollable-menu" role="menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item my-link" href="/branded-vehicles/<?php echo e($brand->brand); ?>"><?php echo e($brand->brand); ?></a>
        ...
        <span class="form-inline my-2 my-lg-0">
          ...
          <i title="Join Network" class="fa fa-handshake-o fa-x mr-4"></i>
          ...
          <a class="text-decoration-none mr-5 my-link" href="<?php echo e(asset('/register')); ?>">Signup</a>
          <?php endif; ?>
          ...
          <div class="dropdown-menu dropdown-menu-right my-dropdown my-login-dropdown" aria-labelledby="navbarDropdown"
            style="width:200px">
            <a class="my-text-hover dropdown-item my-dropdown"
              href="<?php echo e(route('user-account', Auth::user()->username)); ?>">
    ...
    <footer class="page-footer font-small my-dropdown pt-4">
        ...
        <div class="row pb-4">
          ...
          <div class="col-md-3">
            ...
            <ul class="list-unstyled my-text">
              ...
              <li>
                <a class="my-pills-text text-decoration-none" href="<?php echo e(asset('/contact')); ?>/#leave_message">Leave a
      ...
      <ul class="list-unstyled list-inline text-center py-2">
        ...
        <li class="list-inline-item">
          <a href="<?php echo e(asset('/register')); ?>" title="Register Here!" class="btn my-button">Sign up!</a>
        </li>
      </ul>
      <hr />
      <?php endif; ?>
      ...
      <ul class="list-unstyled list-inline text-center pt-2 pb-2">
        <li class="list-inline-item">
          <a class="my-link btn-floating btn-fb mx-1">
            <i title="Facebook" class="fa fa-facebook-square fa-2x"> </i>
          </a>
        </li>
        <li class="list-inline-item">
          <a class="my-link btn-floating btn-tw mx-1">
            <i title="Twitter" class="fa fa-twitter-square fa-2x"> </i>
          </a>
        </li>
        <li class="list-inline-item">
        ...
        <li class="list-inline-item">
          <a class="my-link btn-floating btn-li mx-1">
            <i title="Youtube" class="fa fa-youtube-square fa-2x"> </i>
          </a>
        </li>
      </ul>
      <!-- Social buttons -->
...
</html><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/layout.blade.php ENDPATH**/ ?>