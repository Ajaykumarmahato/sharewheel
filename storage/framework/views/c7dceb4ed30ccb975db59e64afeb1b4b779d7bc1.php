...
<div class="container">
    ...
    <p class="my-text">The result for your brand "<b><?php echo e($brand_filter); ?></b>" are <strong><?php echo e($total_results); ?></strong>
        in this page</p>
    <?php elseif($brand_filter == "" && $category_filter != ""): ?>
    <p class="my-text">The result for your category "<b><?php echo e($category_filter); ?></b>" are :
        <strong><?php echo e($total_results); ?></strong> in this
        page</p>
    <?php elseif($brand_filter != "" && $category_filter != ""): ?>
    <p class="my-text">The result for your brand "<b><?php echo e($brand_filter); ?></b>" and category
        "<b><?php echo e($category_filter); ?></b>" are : <strong><?php echo e($total_results); ?></strong> in this page</p>
    <?php endif; ?>
            ...
            <form action="/filtered-search" method="GET">
                ...
                <div class="div mt-3 mb-3">
                    <select name="sort" id="select" class="form-control my-input">
                        ...
                        <?php endif; ?>
                        <?php if($sort=='newest-arrival'): ?>
                        <option value="newest-arrival" selected>Newest Arrival</option>
                        <?php else: ?>
                        <option value="newest-arrival">Newest Arrival</option>
                        <?php endif; ?>
                        <?php if($sort=='price-high-to-low'): ?>
                        <option value="price-high-to-low" selected>High to Low(Price)</option>
                        <?php else: ?>
                        <option value="price-high-to-low">High to Low(Price)</option>
                        <?php endif; ?>
                        <?php if($sort=='price-low-to-high'): ?>
                        <option value="price-low-to-high" selected>Low to High(Price)</option>
                        <?php else: ?>
                    ...
                    <div class="card mt-3 mb-3">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <?php if($brand->brand == $brand_filter): ?>
                    ...
                    <div class="card mb-3">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <?php if($category->category == $category_filter): ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/filter-product.blade.php ENDPATH**/ ?>