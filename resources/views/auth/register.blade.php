        ...
        <div class="my-login-form my-responsive-signup col-8 pl-4 mb-4 my-bg" style="border-radius: 5px;">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('first_name') is-invalid @enderror"
                        id="first_name" name="first_name" value="{{ old('first_name') }}" autocomplete="first_name"
                        autofocus />
                    @error('first_name')
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('last_name') is-invalid @enderror"
                        id="last_name" name="last_name" value="{{ old('last_name') }}" autocomplete="last_name" />
                    @error('last_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message ?? '' }}</strong>
                    </span>
                ...
                <div class="row my-photo-col">
                    ...
                    <div class="col-7 my-photo-col2">
                        <input type="date" class="my-column-input form-control @error('dob') is-invalid @enderror mb-3"
                            id="dob" placeholder="Country Name" name="dob" value="{{ old('dob') }}"
                            autocomplete="dob" />
                        @error('dob')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message ?? '' }}</strong>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('country_name') is-invalid @enderror"
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('address') is-invalid @enderror" id="address"
                        placeholder="For eg: City, Street Name-Ward Number" name="address" value="{{ old('address') }}"
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="email" class="my-input form-control @error('email') is-invalid @enderror" id="email"
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('contact_number') is-invalid @enderror"
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="my-input form-control @error('liscence_number') is-invalid @enderror"
                        id="liscence_number" placeholder="For eg: 123-321-456" name="liscence_number"
                        value="{{ old('liscence_number') }}" autocomplete="liscence_number" />
                    ...
                    <div class="col-12">
                        ...
                        <button type="submit" name="submit"
                            class="spinner-myRegisterButton btn btn-block my-button text-light"><img
                                src="{{ asset('/images/loading/spinner.gif') }}" alt="spinner"
