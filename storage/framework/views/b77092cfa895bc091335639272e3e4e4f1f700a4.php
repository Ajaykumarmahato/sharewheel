...
<div class="container">
    ...
    <p class="my-text">The result for your category "<b><?php echo e($category_filter); ?></b>" are : <?php echo e($total_results); ?> in this
        page</p>
    <?php elseif($brand_filter != "" && $category_filter != ""): ?>
    <p class="my-text">The result for your brand "<b><?php echo e($brand_filter); ?></b>" and category
        "<b><?php echo e($category_filter); ?></b>" are : <?php echo e($total_results); ?> in this page</p>
    <?php endif; ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/filter-product.blade.php ENDPATH**/ ?>