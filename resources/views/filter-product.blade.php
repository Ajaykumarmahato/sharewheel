...
<div class="container">
    ...
    <p class="my-text">The result for your brand "<b>{{ $brand_filter }}</b>" are <strong>{{$total_results}}</strong>
        in this page</p>
    @elseif($brand_filter == "" && $category_filter != "")
    <p class="my-text">The result for your category "<b>{{ $category_filter }}</b>" are :
        <strong>{{$total_results}}</strong> in this
        page</p>
    @elseif($brand_filter != "" && $category_filter != "")
    <p class="my-text">The result for your brand "<b>{{ $brand_filter }}</b>" and category
        "<b>{{ $category_filter }}</b>" are : <strong>{{$total_results}}</strong> in this page</p>
    @endif
                    ...
                    <div class="card mb-3">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                @if($category->category == $category_filter)
