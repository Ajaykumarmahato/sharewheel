...
<div class="container">
    ...
    <div class="row my-vehicle-list pb-5 mt-5 my-bg">
        <div class="col-12 mb-5 mt-5 text-center">
            ...
            <p class="text-danger">No vehicle to show for "<?php echo e($user_category); ?>"</p>
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/categorized-vehicles.blade.php ENDPATH**/ ?>