            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{ asset('/manager') }}">
                            <img src="{{ asset('/images/logo/sharewheel-logo.png') }}" style="height:60px;width:150px;"
                                alt="ShareWheel" />
                        </a>
                        ...
                        <li>
                            <form action="/manager/search" method="get" class="form-inline my-2 my-lg-0"
                                ...
                                <select name="search_data" id="select2" class="form-control my-input">
                                    @if($model==="all")
                                    <option class="my-dropdown-input" value="{{$model}}">{{ ucfirst($model) }}</option>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <a class="my-desktop-logo" href="{{ asset('/manager') }}">
                                <img src="{{ asset('/images/logo/sharewheel-logo.png') }}"
                            ...
                            <div class="header-button">
                                ...
                                <div class="noti-wrap">
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <span
                                            class="{{ (request()->is('manager-orders')) ? 'd-none' : 'd-block quantity' }}">{{auth()->user()->unreadNotifications->count()}}
                                        </span>
                                        @endif
                                        <div class="notifi-dropdown js-dropdown">
                                            ...
                                            <div class="notification-scrollble">
                                                ...
                                                <a href="/manager/order/order-details-noti/{{$notification->id}}"
                                                    ...
                                                    <div class="notifi__item" style="background-color:#d1fff0">
                                                        ...
                                                        <div class="content">
                                                            <p>{{$notification->data['data']}}
                                                                <b>{{$notification->data['order_info'][0]['first_name']}}
                                                                    {{$notification->data['order_info'][0]['last_name']}}</b>
                                                                for
                                                                <b>{{$notification->data['order_info'][0]['vehicle_title']}}.</b>
                                                                <br><br><i style="font-size:13px"><a
                                                                        href="/notification/mark-as-read/{{$notification->id}}">Mark
                                                                        as Read
                                                                        <!-- <i class="zmdi zmdi-check" title="Mark as Read" style="font-size:20px;color:#24a0f2"></i> -->
                                                                    </a></i>
                                                            </p>
                                                            <span
                                                                class="date">{{\Carbon\Carbon::parse($notification->data['order_info'][0]['created_at'])->format('M-d-Y')}}</span>
                                                        </div>
                                                    </div>
                                                </a>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="/manager-account/{{Auth::user()->username}}"
