                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <span class="feedback-header-text">Add New Product</span>
                                    ...
                                    <div class="col col-md-9">
                                        <div class="my-radio-button form-check-inline form-check">
                                            <label for="inline-radio4" class="form-check-label ">
                                                <input type="radio" id="inline-radio4" name="vehicle_is_published"
                                                    <?php echo e(old('vehicle_is_published') == 1 ? 'checked' : ''); ?> value="1"
                                                    class="form-check-input my-input">YES
                                            </label>
                                            <label for="inline-radio5" class="form-check-label pl-3">
...
<?php echo $__env->make('manager/managerLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/manager/create-product.blade.php ENDPATH**/ ?>