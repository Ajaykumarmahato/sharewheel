...
<div class="container">
    ...
    <div class="row my-vehicle-list pb-5" style="background-color:#F8F9FA">
        <div class="col-12 mb-5 mt-5 text-center">
            ...
            <h3 class="text-danger"> No current vehicle to show for "<?php echo e($user_brand); ?>"</h3>
        </div>
    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ajay\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/branded-vehicles.blade.php ENDPATH**/ ?>