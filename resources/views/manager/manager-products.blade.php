        ...
        <div class="container-fluid">
            <div class="row card">
                <div class="col-lg-12 my-wraper-feedback">
                    ...
                    <div class="row card-body card-block {{ $vehicle->vehicle_is_published == 0 ? 'my-blocked' : '' }}">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <p class="text-justify">
                                {{ Illuminate\Support\Str::limit($vehicle->vehicle_description, 50) }}
                                <!-- {{$vehicle->vehicle_description}}  -->
                                <br>
                                <b>Attributes: </b>
                                {{ Illuminate\Support\Str::limit($vehicle->vehicle_attributes, 50) }}
                                <!-- {{$vehicle->vehicle_attributes}} -->
                            </p>
                            <p><b>Quantity Available: </b>{{$vehicle->vehicle_quantity}} <br>
                                <b>Category: </b>{{ $vehicle->vehicle_category }} <br>
                                <b>No. of Seats: </b>{{ $vehicle->vehicle_seat_number }} <br>
                                <b>Fuel Type: </b>{{ $vehicle->vehicle_fuel_type }} <br>
                                <b>Engine Capacity (CC):</b> {{$vehicle->vehicle_engine}}
                            </p>
                        </div>
                        <div class="col-lg-1">
                            ...
                            @endif
                            <hr>
                            @if($vehicle->vehicle_is_featured == 1)
                        ...
                        <div class="col-lg-2">
                            <div class="table-data-feature mr-5">
                                ...
                                <div class="class-button" style="margin-right:5px">
                                    <a href="/manager-products/edit-product/{{$vehicle->slug}}"
                                        style="background-color:#808080;" class="item" data-toggle="tooltip"
                                        data-placement="top" title="Edit">
                                        <i style="color:white;" class="zmdi zmdi-edit"></i>
                                    </a>
                                </div>
                                <form method="POST" action="/manager-products/{{$vehicle->slug}}">
                                    @csrf
                                    @method('PUT')
                                    @if($vehicle->vehicle_is_published == 0)
                                    <div class="class-button" style="margin-right:5px;margin-left:0px">
                                ...
                                <form method="POST" id="delete-form" action="/manager-products/{{$vehicle->slug}}">
                                    @csrf
                                    @method('DELETE')
