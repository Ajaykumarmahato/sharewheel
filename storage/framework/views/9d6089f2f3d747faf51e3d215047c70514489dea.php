...
<div class="container pt-5 pb-5">
  ...
  <div class="row pl-4 pr-4 pt-5 pb-5">
    <!-- picture -->
    <div class="col-sm-6">
      <img class="image-box" src="<?php echo e(asset('/images/carousel/car3.jpeg')); ?>" />
    </div>
    <div class="col-sm-6">
      <h4>Why we exist?</h4>
      <p class="paragraph">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\priansu\Desktop\MajorProject-12-06-4_15pm\ShareWheel\resources\views/about-us.blade.php ENDPATH**/ ?>