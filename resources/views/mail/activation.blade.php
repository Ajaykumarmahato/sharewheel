...
<div class="container">
    <div class="background">
        <div class="email-container pt-5 pb-5">
            <h2 class="header">Hi, <b>{{$first_name}}</b>!</h2>
            <div class="content">
                <p>Please verify that your email is <b><i>{{$email}}</i></b> and that you entered it when signing up
                    for <b>Sharewheel</b> <br />
                    Also, to activate your user account in <b>ShareWheel,</b> <span>Click on the button below</span>
                </p>
                <a class="btn-btn" href="{{url('user/activation', $link)}}">
            ...
            <a href="{{asset ('/') }}" style="text-align:center"><img
                    src="{{asset('/images/logo/sharewheel-logo.png')}}" class="image" alt="sharewheel"> </a>
